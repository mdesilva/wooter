...
class DeleteLeagueDetailsCommand extends Command implements SelfHandling
{
    /**
     * @var
     */
    ...
    public function handle(LeagueRepository $leagueRepository, UserRepository $userRepository)
    {
        ...
        if ( ! $league->details->delete())
        {
            throw new DatabaseException('There was an error deleting the league details');
        }
