...
class ReadLeaguePlayerFootballQuarterbackStatsCommand extends Command implements SelfHandling
{
    use DispatchesJobs;
    ...
    public function handle(PlayerFootballQuarterbackStatsRepository $quarterbackStatsRepository)
    {
        ...
        $stats = $quarterbackStatsRepository->searchForAverages($params);
