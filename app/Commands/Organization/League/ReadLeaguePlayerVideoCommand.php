...
class ReadLeaguePlayerVideoCommand extends Command implements SelfHandling
{
    /**
     * @var
     */
    ...
    public function handle(LeaguePhotoRepository $leaguePhotoRepository)
    {
         ...
         $videos = $leaguePhotoRepository->getPlayerVideosByLeagueIdAndPlayerId($this->league_id, $this->player_id, $this->offset, $this->limit);
