...
class ReadLeagueTeamFootballStatsCommand extends Command implements SelfHandling
{
    /**
     * @var int
     */
     ...
     * @return array
     */
    public function handle(TeamFootballStatsRepository $teamStatsRepository) {
        $params = [
