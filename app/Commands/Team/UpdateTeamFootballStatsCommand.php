...
use Wooter\Wooter\Repositories\Team\TeamFootballStatsRepository;

class UpdateTeamFootballStatsCommand extends Command implements SelfHandling
{
    use DispatchesJobs;
    ...
    */
     ...
     * @throws UserNotFound
     */
    public function handle(TeamFootballStatsRepository $teamFootballStatsRepository)
    {
        $teamStats = $teamFootballStatsRepository->getByTeamAndGameId($this->teamId, $this->gameId);
        ...
        $teamFootballStatsRepository->update($teamStats);
