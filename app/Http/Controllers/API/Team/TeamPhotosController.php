...
use Wooter\Commands\Team\ReadTeamPhotosCommand;

final class TeamPhotosController extends ApiController
{
    ...
    public function index($team_id)
    {
        try
        {
            ...
            $teamPhotos = $this->dispatchFromArray(ReadTeamPhotosCommand::class, [ "team_id" => $team_id, 'offset' => $offset, 'limit' => $limit, 'orderBy' => $orderBy, 'orderDirection' => $orderDirection]);


            return $this->respond([
                'data' => ['photos' => $this->leaguePhotoTransformer->transformCollection($teamPhotos['photos']),
                    'pages' => $teamPhotos['pages']
                ]
            ]);
        } catch (Exception $e) {
