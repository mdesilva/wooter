...
use Wooter\Wooter\Transformers\Team\TeamBasketballStatsAveragesTransformer;
use Wooter\Wooter\Transformers\Team\TeamSoftballStatsAveragesTransformer;
use Wooter\Wooter\Transformers\Team\TeamFootballStatsAveragesTransformer;

class TeamStatsAveragesTransformer extends Transformer
{
    ...
    public function __construct(TeamBasketballStatsAveragesTransformer $basketballStatsTransformer,
                                TeamSoftballStatsAveragesTransformer $softballStatsTransformer,
                                TeamFootballStatsAveragesTransformer $footballStatsTransformer) 
    {
