...
use Wooter\Wooter\Transformers\Team\TeamBasketballStatsPercentagesTransformer;
use Wooter\Wooter\Transformers\Team\TeamSoftballStatsPercentagesTransformer;
use Wooter\Wooter\Transformers\Team\TeamFootballStatsPercentagesTransformer;

class TeamStatsPercentagesTransformer extends Transformer
{
    ...
    public function __construct(TeamBasketballStatsPercentagesTransformer $basketballStatsTransformer,
                                TeamSoftballStatsPercentagesTransformer $softballStatsTransformer,
                                TeamFootballStatsPercentagesTransformer $footballStatsTransformer) 
    {
