...
<html lang="en" class="errPage">
	<head>
		...
		<link href="//fonts.googleapis.com/css?family=Raleway:400,200,300,500,700" rel="stylesheet" type="text/css">
	...
	<body>
		<div class="pg">
			<div class="cap">403</div>
			
			<span class="icon"><a href="{{ url('/') }}" title="Go to Home">{!! entypo('fingerprint') !!}</a></span>
			
			<h1>Don't Have permission to access this folder!</h1>
