...
<div class="hero_image">
	<div class="hero_text">
		<h1>Sports League Insurance</h1>
		<p>Make sure you're covered in case</p>
		<p>of any accident or liability.</p>
		<a target='_blank' href="https://www.sportsinsurance.com/?ref=wooter.co"><button class="yellow_btn md-whiteframe-4dp">Apply Now</button></a>
	</div>
</div>
...
<div class="black_space">
	<div class="black_popup commissioners">
		<div class="red_pics">
			<div class="image">
				<img src="/img/landings/shield.png" alt="">
			</div>
			<div class="faq">
				<p>You can’t stop accidents from happening, <br> but you can make yourself feel prepared.</p>
			</div>			
		</div>
...
<div class="white_space space_one">
	<div class="white_popup md-whiteframe-4dp strategy popup_one">
		<div class="pricing_text">
			<h1>Sports Insurance Program</h1>
...
<div class="white_button">
	<p><a target='_blank' href="https://www.sportsinsurance.com/?ref=wooter.co"><button class='yellow_btn md-whiteframe-4dp'>Apply Now</button></a></p>
</div>
