...
@section('headJS')
  ...
  <script src="/js/vendors/angular/angular-route.js" type="text/javascript"></script>
  ...
  <script type="text/javascript">
    var landing = angular.module('landing', ['ngMaterial','ngDropdowns','ngAnimate','ngMask','ui.router']);
  </script>

  <script src="/js/landing/layout/header.js"></script>
  <script src="/js/landing/layout/script.js"></script>
  <script src="/js/vendors/favicon/index.js"></script>
