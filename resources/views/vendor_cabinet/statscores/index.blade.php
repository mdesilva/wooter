...
<div class='main' ng-controller='scheduleCtrl' ng-cloak id='popupContainer'>
	...
	<md-content class="schedule_content" ng-init='genSchedule()'>
		<md-list class="md-whiteframe-2dp">
			...
			<md-list-item>
				...
				<md-button class="md-secondary md-accent new_teambtn" ng-click="addScores($event)">UPLOAD STATS</md-button>
			</md-list-item>
	...
	<div ng-controller='statScoreCtrl' ng-repeat='match in matches' class='schedules_list' style='max-width: 1280px; left: 0; right: 0; margin: auto; margin-top: 15px'>
	    <md-list>
			...
			<div class='md-whiteframe-2dp' ng-repeat='schedule in match.schedule' ng-init='addPlayerToTeam()'>
				...
				<md-list-item ng-repeat='matchup in schedule.slots' style='background-color: white'>
					...
					<md-icon class='material_icons md-secondary' ng-click='addScores($event)'>
						mode_edit
					</md-icon>
					<md-divider></md-divider>
				</md-list-item>
